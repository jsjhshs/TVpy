...
# -*- coding: utf-8 -*-
"""
天马行空 Spider - 四壳通用Python Spider
站点: https://srf.tmxk3.boats/tmxk/
"""
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://srf.tmxk3.boats/tmxk"
        self.rawUrl = "https://srf.tmxk3.boats/tmxk"
        return "天马行空"
    ...
    def detailContent(self, ids):
        ...
        vod_list = [{
            ...
            "vod_play_from": "天马行空", "vod_play_url": play_url
        }]
