...
# -*- coding: utf-8 -*-
"""
原创伙伴 Spider - 四壳通用Python Spider
站点: https://ddj.ychb4.pics/ychb/
"""
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://ddj.ychb4.pics/ychb"
        self.rawUrl = "https://ddj.ychb4.pics/ychb"
        return "原创伙伴"

    def homeContent(self, filter):
        result = {}
        class_name = []
        for i in [1] + list(range(20, 28)):
    ...
    def detailContent(self, ids):
        ...
        vod_list = [{
            ...
            "vod_play_from": "原创伙伴", "vod_play_url": play_url
        }]
