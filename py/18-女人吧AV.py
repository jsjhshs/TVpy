...
# -*- coding: utf-8 -*-
"""
女人吧AV Spider - 四壳通用Python Spider
站点: https://sjf.nrbav6.lat/nrbav/
"""
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://sjf.nrbav6.lat/nrbav"
        self.rawUrl = "https://sjf.nrbav6.lat/nrbav"
        return "女人吧AV"
    ...
    def detailContent(self, ids):
        ...
        vod_list = [{
            ...
            "vod_play_from": "女人吧AV", "vod_play_url": play_url
        }]
