...
# -*- coding: utf-8 -*-
"""
蘑菇视频 Spider - 四壳通用Python Spider
站点: https://www.mgsp2.autos/mgsp/
"""
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://www.mgsp2.autos/mgsp"
        self.rawUrl = "https://www.mgsp2.autos/mgsp"
        return "蘑菇视频"
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        list = []
        items = re.findall(r'<a class="video-image-a" href="(/\d+\.html)"[^>]*>(.*?)</a>', html, re.S)
        seen = set()
    ...
    def detailContent(self, ids):
        ...
        vod_list = [{
            ...
            "vod_play_from": "蘑菇视频", "vod_play_url": play_url
        }]
