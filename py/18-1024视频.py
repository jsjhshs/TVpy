...
# -*- coding: utf-8 -*-
"""
1024视频 Spider - 四壳通用Python Spider
站点: https://www.1024sp9.beer/1024sp/
"""
...
try:
    ...
    class Spider:
        ...
        def getName(self): return "1024视频"
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://www.1024sp9.beer/1024sp"
        self.rawUrl = "https://www.1024sp9.beer/1024sp"
        return "1024视频"
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        list = []
        items = re.findall(r'<a href="(/\d+\.html)"[^>]*>\s*<i[^>]*></i>\s*</a>\s*<p>(.*?)</p>', html, re.S)
        seen = set()
        for href, title in items:
            ...
            list.append({"vod_id": id_m.group(1), "vod_name": title.strip(), "vod_pic": "", "vod_remarks": ""})
    ...
    def detailContent(self, ids):
        ...
        vod_list = [{
            ...
            "vod_play_from": "1024视频", "vod_play_url": play_url
        }]
